# Anexo metodológico y de trazabilidad v1.5

Este anexo complementa v1.1, v1.2 y v1.3 con capas derivadas reproducibles. No modifica los CSV congelados.
...
| Sin S3 al corte original | 51 sesiones: 33 Black Hat USA, 18 Virus Bulletin |
...
## H. Auditorías y réplica operativa v1.5

- Triage mecánico de evidencia: P0 1 incumplimiento sin URL; P1 17 indeterminados sin URL; P2 14 indeterminados con URL; P4 88 restantes. No son juicios nuevos.
- Sesiones S3: 138 identificadores, 36 aportantes y 102 sin predicciones incluidas. El [marco maestro original](../work/marco_maestro_189_sesiones_v0.9.csv) ahora publica las 189 filas: las 51 no S3 son 29 `pending_archive`, 4 `pending_manual`, 17 `pending_paper` y 1 S1. El template v1.4 quedó vacío como testimonio del diagnóstico anterior; no es el inventario recuperado.
- La [auditoría posterior v1.5](recuperacion_marco_y_fuentes_v1.5.md) localizó dos papers integrales Virus Bulletin entre las 17 fuentes originalmente pendientes. Ninguno se suma retrospectivamente a las 138 S3 del análisis principal.
- Disponibilidad HTTP del 15 de septiembre de 2026: 161 éxitos, 13 no encontradas, 23 bloqueadas o limitadas, 18 fallos de red y 3 errores adicionales entre 218 rol–URL. No se preservó contenido remoto.
- Una URL de predicción 404 en siete casos de `CCC-2018-085` tiene alternativa oficial ya consignada en el orden S3, con respuesta 200. El CSV de alternativas conserva ambos localizadores.
- Auditar la palabra modal en una cita no decide si el ponente se comprometió. Cinco pistas léxicas y dos casos prioritarios permanecen sin reauditar.
- La tarjeta prospectiva no tiene filas; el puntuador sólo fue probado con casos sintéticos. No existe aún resultado prospectivo.

## I. Derechos y publicación

El paquete v1.5 aplica MIT al software y CC BY 4.0 sólo a aportes originales de investigación/datos; el material literal de terceros queda excluido conforme a `RIGHTS.md`. El repositorio GitHub se publica para reproducibilidad. La publicación académica definitiva aún requiere depósito inmutable con DOI y declaraciones editoriales de financiación, conflictos y ética.
