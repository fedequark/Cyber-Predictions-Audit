# Anexo metodológico y de trazabilidad v1.4
...
## H. Auditorías y réplica operativa v1.4
...
- Sesiones S3: 138 identificadores, 36 aportantes y 102 sin predicciones incluidas. Las 51 no S3 sólo están como agregado; el template de reconstrucción está vacío.
...
El paquete v1.4 aplica MIT al software y CC BY 4.0 sólo a aportes originales de investigación/datos; el material literal de terceros queda excluido conforme a `RIGHTS.md`. El repositorio GitHub se publica para reproducibilidad. La publicación académica definitiva aún requiere depósito inmutable con DOI y declaraciones editoriales de financiación, conflictos y ética.
