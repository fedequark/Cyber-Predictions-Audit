...
**Versión 1.5 — 15 de septiembre de 2026.** Actualización de procedencia documental; desenlaces congelados sin cambios.
...
**Auditoría de trazabilidad v1.5.** Una correspondencia de ID afecta siete casos de una sesión: extracción `CCC-2013-034` frente a orden S3 `CCC-2013-043`; coinciden orden y URL oficial. Se recuperó el marco maestro original de 189 filas: las 138 S3 coinciden con el orden congelado y las 51 no S3 tienen identificador y título. Entre estas últimas había 50 búsquedas documentales pendientes y una S1 al corte original. Dos papers Virus Bulletin se localizaron después de la congelación; no entran retrospectivamente en la muestra. Una consulta de encabezados a 218 localizadores obtuvo 161 respuestas accesibles y 13 respuestas 404; el único 404 de fuente de predicción tiene alternativa oficial ya listada en el orden S3. Esto no prueba validez o invalidez de los juicios ni preserva las fuentes. Cinco citas contienen pistas modales para revisión contextual; ningún caso se excluyó o recodificó.
...
El marco cerrado contiene 189 sesiones entre 2005 y 2018. Ciento treinta y ocho tenían disponibilidad S3 **al corte original**: grabación sustancialmente completa, transcripción completa, paper integral o diapositivas autosuficientes. Las otras 51 no entraron en la extracción original; 50 estaban pendientes de resolver documentalmente y una era S1. Su falta de unidades no equivale a un pronóstico errado ni a ausencia permanente de fuentes. RSA Conference se excluyó al no poder reconstruirse un denominador histórico reproducible.
...
### 3.7 Auditoría fila por fila de marco, enlaces y compromiso

La capa v1.4 prioriza un incumplimiento sin URL probatoria (P0), 17 indeterminados sin URL (P1) y 14 indeterminados con alguna URL (P2). Otros 88 casos quedan para preservación de localizadores. La ausencia de URL no equivale a ausencia de evidencia y la priorización no cambia el juicio congelado. La comprobación HTTP de encabezados produjo 161 accesibles, 13 no encontradas, 23 bloqueadas o limitadas, 18 fallos de red y 3 errores restantes; requiere revisión manual y no sustituye copias archivadas. Un enlace 404 de predicción afectaba siete casos de `CCC-2018-085`; el orden S3 ya consignaba otra URL oficial para la misma sesión y esa alternativa respondió 200. Se conservan ambos localizadores sin afirmar preservación del contenido.

Una búsqueda focal inicial del caso P0 no encontró una fuente calificante, pero no fue exhaustiva y no respalda una inferencia de no ocurrencia. El juicio congelado permanece visible junto con la sensibilidad que lo trata hipotéticamente como indeterminado.

El cruce de los 138 identificadores S3 con las 36 sesiones aportantes detectó la correspondencia `CCC-2013-034`/`CCC-2013-043` en siete predicciones. El orden y la URL oficial concuerdan, pero la discrepancia debe permanecer visible en los datos originales. Las nueve celdas de conferencia y periodo son muy desiguales: en 2005–2009 hubo sólo 2 sesiones S3 de Black Hat USA y 1 de Virus Bulletin, frente a 21 de CCC. El marco maestro original de 189 filas, recuperado en v1.5, permite comprobar las 51 no S3 por ID, título y periodo: 17 en 2005–2009, 24 en 2010–2014 y 10 en 2015–2018. Su distribución no repara el sesgo de disponibilidad de la muestra original. Dos papers integrales Virus Bulletin se localizaron **después** del corte; cualquier extracción nueva pertenecería a una ampliación registrada por separado.

La auditoría A/B conserva cinco clases A y 115 B. Cinco fragmentos presentan una palabra modal; dos merecen revisar la adopción del pronóstico directamente en el recurso original. Es un filtro léxico post hoc, no una invalidación semántica. La réplica prospectiva operativa tiene tarjeta, validaciones y puntuador, pero no contiene pronósticos reales ni un registro externo temporal previo.
...
- Hubo un solo codificador; la doble codificación prevista sigue pendiente y sigue pospuesta en v1.5.
- No existe registro fila por fila de candidatos textuales excluidos. Las 51 sesiones no S3 ya tienen inventario original, pero 50 tenían disponibilidad pendiente y su búsqueda no estaba agotada.
- Las fuentes remotas pueden cambiar o desaparecer; el inventario preserva localizadores y cápsulas textuales, no todos los bytes originales. La consulta HTTP v1.4 tampoco preserva contenido.
...
- [Auditoría de evidencia y muestra v1.4](auditoria_muestra_y_evidencia_v1.4.md)
- [Recuperación del marco y fuentes v1.5](recuperacion_marco_y_fuentes_v1.5.md)
- [Marco maestro original de 189 sesiones](../work/marco_maestro_189_sesiones_v0.9.csv)
- [Triage de evidencia](../work/triage_evidencia_v1.4.csv)
- [Revisión focal inicial del caso P0](nota_revision_focal_caso_p0_v1.4.md)
- [Rendimiento de sesiones S3](../work/rendimiento_sesiones_s3_v1.4.csv)
- [Disponibilidad de enlaces](revision_disponibilidad_fuentes_2026-09-15.md)
- [Alternativa oficial de enlace roto](../work/alternativas_enlaces_fuentes_v1.4.csv)
- [Auditoría de compromiso y operacionalización](auditoria_compromiso_y_operacionalizacion_v1.4.md)
- [Protocolo de ampliación estratificada](protocolo_ampliacion_estratificada_v1.4.md)
- [Réplica prospectiva operativa](protocolo_replica_prospectiva_operativo_v1.4.md)
- [Plan de DOI y preregistro externo](plan_deposito_doi_y_preregistro_v1.4.md)
