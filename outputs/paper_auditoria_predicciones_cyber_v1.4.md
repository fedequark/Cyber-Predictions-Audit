...
**Auditoría de trazabilidad v1.4.** Una correspondencia de ID afecta siete casos de una sesión: extracción `CCC-2013-034` frente a orden S3 `CCC-2013-043`; coinciden orden y URL oficial. Los 51 registros no S3 del marco sólo están documentados como agregado. Una consulta de encabezados a 218 localizadores obtuvo 161 respuestas accesibles y 13 respuestas 404; el único 404 de fuente de predicción tiene alternativa oficial ya listada en el orden S3. Esto no prueba validez o invalidez de los juicios ni preserva las fuentes. Cinco citas contienen pistas modales para revisión contextual; ningún caso se excluyó o recodificó.
...
El cruce de los 138 identificadores S3 con las 36 sesiones aportantes detectó la correspondencia `CCC-2013-034`/`CCC-2013-043` en siete predicciones. El orden y la URL oficial concuerdan, pero la discrepancia debe permanecer visible en los datos originales. Las nueve celdas de conferencia y periodo son muy desiguales: en 2005–2009 hubo sólo 2 sesiones S3 de Black Hat USA y 1 de Virus Bulletin, frente a 21 de CCC. Las 51 sesiones no S3 del marco 189 no tienen inventario individual publicado; hasta reconstruirlo no puede verificarse su composición por periodo ni rescatarlas sin una nueva selección documentada.
...
- Hubo un solo codificador; la doble codificación prevista sigue pendiente y sigue pospuesta en v1.4.
- No existe registro fila por fila de candidatos textuales excluidos ni de las 51 sesiones no S3 del marco original.
